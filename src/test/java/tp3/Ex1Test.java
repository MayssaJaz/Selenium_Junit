...
public class Ex1Test {
    ...
    public void todoTestCase() throws Exception {
        ...
        addTodo("Read a book");
        addTodo("Call the client");
        addTodo("Meditation");
        Thread.sleep(2000);
        tickTodo(2);
        Thread.sleep(1000);
        assertRemainingTodos(2);
        takeScreenshot(driver, "/home/missa/eclipse-workspace/tp3/screenshots/test_no_params");
        ;
    }
    ...
    public void todosTestCase(String technology) throws Exception {
        ...
        tickTodo(2);
        assertRemainingTodos(2);
        takeScreenshot(driver, "/home/missa/eclipse-workspace/tp3/screenshots/image_" + technology + ".png");
    }
